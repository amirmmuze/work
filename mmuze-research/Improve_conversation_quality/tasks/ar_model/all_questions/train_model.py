...
execuation:
    ...
    spark-submit /Users/amirdavidoff/mmuze-research/Improve_conversation_quality/tasks/ar_model/all_questions/train_model.py --df-source /Users/amirdavidoff/mmuze-research/Improve_conversation_quality/tasks/ar_model/all_questions/op/df.csv --dest /Users/amirdavidoff/mmuze-research/Improve_conversation_quality/tasks/ar_model/all_questions/op
...
def train_model(df_path,dest):
    ...
    for c in top_features:
        ...
        # some features had / in them making the "directory" not found
        c = c.replace("/","_")
